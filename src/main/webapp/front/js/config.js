...
var centerMenu = [
    ...
    ,{
        name: '技术收藏',
        url: '../jishuCollection/list.html'
    }
    ,{
        name: '文献收藏',
        url: '../wenxianCollection/list.html'
    }
    ,{
        name: '模块',
        url: '../mokuai/list.html'
    }
    ,{
        name: '模块经费使用',
        url: '../mokuaiHuafei/list.html'
    }
    ,{
        name: '管理员私信',
        url: '../sixin/list.html'
...
var indexNav = [
    ...
    {
        name: '文献',
        url: './pages/wenxian/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/ruanjianxiangmu/admin/dist/index.html#/login";
