            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.xiangmujingliId">
                            项目经理
                        </span>
...
|| (sessionTable == 'xiangmujingli' && scope.row.xiangmujingliId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/ruanjianxiangmu/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.xiangmujingliId = el.xiangmujingliId;//---
                            forum.xiangmujingliName = el.xiangmujingliName;
                            forum.xiangmujingliPhone = el.xiangmujingliPhone;
                            forum.xiangmujingliIdNumber = el.xiangmujingliIdNumber;
                            forum.xiangmujingliPhoto = el.xiangmujingliPhoto;
                            forum.xiangmujingliEmail = el.xiangmujingliEmail;
                            forum.createTime = el.createTime;
