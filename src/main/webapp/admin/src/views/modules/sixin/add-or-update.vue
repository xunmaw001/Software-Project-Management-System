    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="私信标题" prop="sixinName">
                       <el-input v-model="ruleForm.sixinName"
                                 placeholder="私信标题" clearable  :readonly="ro.sixinName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="私信标题" prop="sixinName">
                           <el-input v-model="ruleForm.sixinName"
                                     placeholder="私信标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="私信内容" prop="sixinText">
                        <el-input type="textarea"  :readonly="ro.sixinText" v-model="ruleForm.sixinText" placeholder="私信内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.sixinText" label="私信内容" prop="sixinText">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   sixinName: [
                              { required: true, message: '私信标题不能为空', trigger: 'blur' },
                          ],
                   sixinText: [
                              { required: true, message: '私信内容不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
                              { required: true, message: '私信时间不能为空', trigger: 'blur' },
                          ],
                   replyText: [
