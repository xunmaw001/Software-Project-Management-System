               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="项目经理姓名" prop="xiangmujingliName">
                       <el-input v-model="ruleForm.xiangmujingliName"
                                 placeholder="项目经理姓名" clearable  :readonly="ro.xiangmujingliName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="项目经理手机号" prop="xiangmujingliPhone">
                       <el-input v-model="ruleForm.xiangmujingliPhone"
                                 placeholder="项目经理手机号" clearable  :readonly="ro.xiangmujingliPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="项目经理身份证号" prop="xiangmujingliIdNumber">
                       <el-input v-model="ruleForm.xiangmujingliIdNumber"
                                 placeholder="项目经理身份证号" clearable  :readonly="ro.xiangmujingliIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="项目经理邮箱" prop="xiangmujingliEmail">
                       <el-input v-model="ruleForm.xiangmujingliEmail"
                                 placeholder="项目经理邮箱" clearable  :readonly="ro.xiangmujingliEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                ro:{
                    username: false,
                    password: false,
                    xiangmujingliName: false,
                    xiangmujingliPhone: false,
                    xiangmujingliIdNumber: false,
                    xiangmujingliPhoto: false,
                    sexTypes: false,
                    xiangmujingliEmail: false,
                },
                ruleForm: {
                    username: '',
                    password: '',
                ...
                rules: {
                   ...
                   xiangmujingliPhone: [
                              {  required: true, message: '项目经理手机号不能为空', trigger: 'blur' },
                   ...
                   xiangmujingliIdNumber: [
                              { required: true, message: '项目经理身份证号不能为空', trigger: 'blur' },
                              { pattern: /^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$/,
                                message: '项目经理身份证号格式有误！',
                                trigger: 'blur'
                              }
                          ],
                   xiangmujingliPhoto: [
                              { required: true, message: '项目经理头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
                   ...
                   xiangmujingliEmail: [
                              { required: true, message: '项目经理邮箱不能为空', trigger: 'blur' },
                              { pattern: /^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+(.[a-zA-Z0-9_-])+/,
                                message: '项目经理邮箱只能是邮箱格式',
                                trigger: 'blur'
                              }
                          ],
                }
