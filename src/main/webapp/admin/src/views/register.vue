    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">软件项目管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="项目经理姓名" class="input" v-if="tableName=='xiangmujingli'">
                            <el-input v-model="ruleForm.xiangmujingliName" autocomplete="off" placeholder="项目经理姓名"  />
                        </el-form-item>
                        <el-form-item label="项目经理手机号" class="input" v-if="tableName=='xiangmujingli'">
                            <el-input v-model="ruleForm.xiangmujingliPhone" autocomplete="off" placeholder="项目经理手机号"  />
                        </el-form-item>
                        <el-form-item label="项目经理身份证号" class="input" v-if="tableName=='xiangmujingli'">
                            <el-input v-model="ruleForm.xiangmujingliIdNumber" autocomplete="off" placeholder="项目经理身份证号"  />
                        </el-form-item>
                        <!--
                            <el-form-item v-if="xiangmujingliPhotoFlag">
                            </el-form-item>
                            <el-form-item label="项目经理头像" class="input" v-if="tableName=='xiangmujingli'">
                                    <file-upload
                                        tip="点击上传项目经理头像"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        -->
                        <el-form-item label="项目经理邮箱" class="input" v-if="tableName=='xiangmujingli'">
                            <el-input v-model="ruleForm.xiangmujingliEmail" autocomplete="off" placeholder="项目经理邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='xiangmujingli'">
    ...
    export default {
        data() {
            return {
                ...
                rules: {},
                sexTypesOptions : [],
                xiangmujingliPhotoFlag:false,//用于刷新文件上传
        ...
        methods: {
            ...
            xiangmujingliPhotoUploadChange(fileUrls) {
               this.ruleForm.xiangmujingliPhoto = fileUrls;
                if(this.xiangmujingliPhotoFlag){
                    this.xiangmujingliPhotoFlag=false;
                }else{
                    this.xiangmujingliPhotoFlag=true;
                }
            },
            ...
            login() {
                            ...
                            if((!this.ruleForm.xiangmujingliName)&& 'xiangmujingli'==this.tableName){
                                this.$message.error('项目经理姓名不能为空');
                                return
                            }
                             if('xiangmujingli' == this.tableName && this.ruleForm.xiangmujingliPhone&&(!this.$validate.isMobile(this.ruleForm.xiangmujingliPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.xiangmujingliIdNumber)&& 'xiangmujingli'==this.tableName){
                                this.$message.error('项目经理身份证号不能为空');
                                return
                            }
                            // xiangmujingli 中的 项目经理头像 判空处理
                            // if('xiangmujingli' == this.tableName && (this.ruleForm.xiangmujingliPhoto== null ||this.ruleForm.xiangmujingliPhoto== "")){
                            //     this.$message.error("项目经理头像不能为空");
                            //     return
                            // }
                            if('xiangmujingli' == this.tableName && this.ruleForm.xiangmujingliEmail&&(!this.$validate.isEmail(this.ruleForm.xiangmujingliEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                            // xiangmujingli 中的 创建时间 判空处理
                            // if('xiangmujingli' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){
...
<style lang="scss" scoped>
    ...
    .container {
        ...
        background-image: url(/ruanjianxiangmu/img/back-img-bg.jpg);
