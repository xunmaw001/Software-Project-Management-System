...
, "usersId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
            ...
            //级联表 项目经理
            //级联表
            XiangmujingliEntity xiangmujingli = xiangmujingliService.selectById(forum.getXiangmujingliId());
            if(xiangmujingli != null){
            BeanUtils.copyProperties( xiangmujingli , view ,new String[]{ "id", "createTime", "insertTime", "updateTime", "yonghuId"
, "xiangmujingliId"
, "usersId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(false)
            ...
            forum.setXiangmujingliId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ForumEntity> queryWrapper = new EntityWrapper<ForumEntity>()
            ...
            .eq("xiangmujingli_id", forum.getXiangmujingliId())
...
//                            forumEntity.setXiangmujingliId(Integer.valueOf(data.get(0)));   //项目经理 要改的
